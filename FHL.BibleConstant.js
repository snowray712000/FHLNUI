...
/**
 * @typedef {"创"|"出"|"利"|"民"|"申"|"书"|"士"|"得"|"撒上"|"撒下"|"王上"|"王下"|"代上"|"代下"|"拉"|"尼"|"斯"|"伯"|"诗"|"箴"|"传"|"歌"|"赛"|"耶"|"哀"|"结"|"但"|"何"|"珥"|"摩"|"俄"|"拿"|"弥"|"鸿"|"哈"|"番"|"该"|"亚"|"玛"|"太"|"可"|"路"|"约"|"徒"|"罗"|"林前"|"林后"|"加"|"弗"|"腓"|"西"|"帖前"|"帖后"|"提后"|"提后"|"多"|"门"|"来"|"雅"|"彼前"|"彼后"|"约一"|"约二"|"约三"|"犹"|"启"} TPCHINESE_BOOK_ABBREVIATIONS_GB
 */
