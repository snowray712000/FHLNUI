...
export class ParsingPopUp {
    static #s = null
    /** @returns {ParsingPopUp} */
    static get s() { if (!this.#s) this.#s = new ParsingPopUp(); return this.#s }
    ...
    registerEvents(ps){
            ...
            $('.snParse').on('click',function () {
                //var offset=parsingPopUp.dom.offset;
                ps.N = $(this).attr('N');
                ps.k = $(this).html();
                ParsingPopUp.s.render(ps, ParsingPopUp.s.dom, null);
            });
            $('.searchBibleVerse').on('click',function () {
