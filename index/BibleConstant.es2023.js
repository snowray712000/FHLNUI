...
export class BibleConstant{
    ...
    /** @const {string[]} '創', '出', '利'... */
    static CHINESE_BOOK_ABBREVIATIONS = [
        '創', '出', '利', '民', '申',
    ...
    /** @const {string[]} '创', '出', '利',... */
    static CHINESE_BOOK_ABBREVIATIONS_GB = [
        '创', '出', '利', '民', '申',
    ...
    static ENGLISH_BOOK_ABBREVIATIONS = [
        'Gen', 'Ex', 'Lev', 'Num', 'Deut',
    ...
    static ENGLISH_BOOK_SHORT_ABBREVIATIONS = [
        'Ge', 'Ex', 'Le', 'Nu', 'De',
        'Jos', 'Jud', 'Ru', '1Sa', '2Sa',
